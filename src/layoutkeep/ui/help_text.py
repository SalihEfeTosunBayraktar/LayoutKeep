    ...
    "tr": {
        "first": {
            ...
            "body": (
                ...
                "Uzun koşularda pencere kendiliğinden yüzen çubuğa geçer: ilerleme orada sürer, "
                "çubuktaki “Pencereye dön” geri getirir.\n\n"
    ...
    "en": {
        "first": {
            ...
            "body": (
                ...
                "For a long run the window steps aside into the floating bar by itself: the run "
                "carries on there, and “Back to window” on the bar brings it back.\n\n"

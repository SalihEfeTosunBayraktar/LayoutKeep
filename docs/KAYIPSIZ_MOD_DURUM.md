...
| **D1** (296-509 blok) | Gemini'nin elastic flow fikrinin doğrusu: `fitting/room.py`'nin boş alan ölçümüyle bloğu aşağı doğru büyütmek, fontu okunabilirlik tabanının altına indirmek yerine | Yazıcının temizleme ve komşu kurallarıyla birlikte değişmeli; tek başına `bbox.height` oynatmak L7/L8 üretir |
